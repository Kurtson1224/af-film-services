...
export function Header() {
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200/80 sticky top-0 z-20 flex items-center justify-between px-6 shadow-xs">
      ...
      <div className="relative w-96">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search equipment, rental orders, clients, serials..."
            value={searchQuery}
            onChange={(e) => {
            ...
            className="w-full bg-slate-100/80 hover:bg-slate-100 text-xs font-medium text-slate-800 pl-10 pr-4 py-2.5 rounded-xl border border-transparent focus:border-accent focus:bg-white focus:outline-none transition-all"
          />
          {searchQuery && (
            <button 
